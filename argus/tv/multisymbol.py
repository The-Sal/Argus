...
class Ticker:
    def __init__(self, callback, symbols="BINANCE:BTCUSDT", save=False, database_name="database.db", split_symbols=False,
                 verbose=False, auth_token="unauthorized_user_token"):
    ...
    async def connect(self):
        self.connection = await websockets.connect("wss://data.tradingview.com/socket.io/websocket",
    ...
    async def authenticate(self):
        ...
        await self.sendMessage("set_auth_token", [self.auth_token])
        ...
        await self.sendMessage("quote_set_fields",
                               [qsl, "base-currency-logoid", "ch", "chp", "currency-logoid", "currency_code",
                                ...
                                "listed_exchange", "logoid", "lp", "lp_time", "minmov", "minmove2", "original_name",
                                "pricescale", "pro_name", "short_name", "type", "typespecs", "update_mode", "volume",
