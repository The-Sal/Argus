...
WARNING: YOU ARE USING A NON-MAINTAINED BRANCH OF ARGUS.
THIS VERSION MAY CONTAIN BUGS AND MISSING FEATURES. THIS VERSION HAS THE LEGACY POLYMARKET-DISPATCHER
WHICH IS NO LONGER MAINTAINED OR SUPPORTED AND REPLACED BY A NEW DISPATCHER THAT WILL BE BASED ON POLYMARKET_DIRECT
